...
class RFB_modified(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.branch3 = nn.Sequential(
            ...
            BasicConv2d(out_channel, out_channel, kernel_size=(7,1), paddding=(3, 0)),
...
class Aggregation(nn.Module):
    ...
    def forward(self, x1, x2, x3):
        x1_1 = x1
        x2_1 = self.conv_upsample1(self.upsample(x1)) * x2_1
...
class Paranet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.resnet.maxpool(x) # bs, 64, 8, 8
        ...
        lateral_map_5 = F.interpolate(ra5_feat, scale_factor=8, mode='bilinear') # bs, 1, 352, 352
        # ------------------
